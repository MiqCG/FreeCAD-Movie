...
5. The targets of the Movie Cameras can be adjusted to follow paths, fixed or mobile points or objects or leaving it free to permit use of rotations angles, for example.
